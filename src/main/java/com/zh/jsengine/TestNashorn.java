...
public class TestNashorn {
	...
	public static void main(String[] args) throws FileNotFoundException {
		FileReader fr = new FileReader(TestNashorn.class.getResource("/conf/quzhou.js").getPath());
